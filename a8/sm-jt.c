...
int exec() {
  ...
  int addr, val;
      ...
      static const void* jt1[16] = { &&L0, &&L1, &&L2, &&L3, &&L4, &&DEFAULT, &&L6, &&L7, &&L8, &&L9, &&L10, &&L11, &&L12, &&L13, &&L14, &&L15};
      static const void* jt2[16] = { &&L00, &&L01, &&L02, &&L03, &&L04, &&L05, &&L06, &&L07, &&DEFAULT2, &&DEFAULT2, &&DEFAULT2, &&DEFAULT2,
        &&DEFAULT2, &&DEFAULT2, &&DEFAULT2, &&L015};
      if(insOpCode < 0 || insOpCode > 16) goto DEFAULT;
      goto *jt1 [insOpCode];
      // ld $i, d .............. 0d-- iiii iiii
  L0: ;
      reg [insOp0] = insOpExt;
  ...
  L4:  ; // st rs, (rd, ri, 4) .... 4sdi
        ...
        goto CONT;
  L6: ; // ALU ................... 6-sd
        if(insOp0 < 0 || insOp0 > 16) goto DEFAULT2;
        goto *jt2 [insOp0];
     ...
     L015: ; // gpc ............... 6f-r
              ...
              goto CONT2;
DEFAULT2: printf ("Illegal ALU instruction: pc=0x%x fun=0x%x\n", pc, insOp0);
